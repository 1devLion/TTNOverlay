...
internal static partial class RuStrings
{
    private static readonly Dictionary<string, string> SettingsAboutEntries = new()
    {
        ...
        ["Settings_About_DebugModeWarning"] = "Включение режима отладки влияет на производительность — включайте его только для диагностики конкретной проблемы, а затем отключайте.",
    };
}