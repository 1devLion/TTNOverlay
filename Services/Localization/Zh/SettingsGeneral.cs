...
internal static partial class ZhStrings
{
    private static readonly Dictionary<string, string> SettingsGeneralEntries = new()
    {
        ...
        ["Settings_General_ChatSource"] = "聊天来源",
        ["Settings_ChatSource_Twitch"] = "Twitch",
        ["Settings_ChatSource_Kick"] = "Kick",
        ["Settings_ChatSource_Multichat"] = "多平台聊天（Twitch + Kick）",
        ["Settings_General_ChannelKick"] = "Kick 频道",
        ["Settings_General_ChannelShared"] = "频道",
        ["Settings_General_MultichatEnableTwitch"] = "启用 Twitch",
        ["Settings_General_MultichatEnableKick"] = "启用 Kick",
        ["Settings_General_MultichatUseSameChannel"] = "两者使用相同的频道名称",
