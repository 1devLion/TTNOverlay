...
internal static partial class FrStrings
{
    private static readonly Dictionary<string, string> SettingsTwitchApiEntries = new()
    {
        ...
        ["Settings_TwitchApi_ViewerCountMode"] = "Affichage du nombre de spectateurs",
        ["Settings_ViewerCountMode_Sum"] = "Total (somme de toutes les plateformes)",
        ["Settings_ViewerCountMode_PerPlatform"] = "Personnalisé",
        ["Settings_TwitchApi_ViewerCountIncludeTwitch"] = "Inclure Twitch",
        ["Settings_TwitchApi_ViewerCountIncludeKick"] = "Inclure Kick",
        ["Settings_TwitchApi_ViewerCountIncludeYouTube"] = "Inclure YouTube",
        ["Settings_TwitchApi_ViewerCountBackground"] = "Fond du compteur de spectateurs",
        ["Settings_TwitchApi_ViewerCountTextColor"] = "Couleur du texte du compteur de spectateurs",
        ["Settings_TwitchApi_ViewerCountSize"] = "Taille du compteur de spectateurs",
        ["Settings_TwitchApi_ResetViewerCountColor"] = "Réinitialiser la couleur du thème",
