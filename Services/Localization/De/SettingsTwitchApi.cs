...
internal static partial class DeStrings
{
    private static readonly Dictionary<string, string> SettingsTwitchApiEntries = new()
    {
        ...
        ["Settings_TwitchApi_ViewerCountMode"] = "Anzeige der Zuschauerzahl",
        ["Settings_ViewerCountMode_Sum"] = "Gesamt (Summe aller Plattformen)",
        ["Settings_ViewerCountMode_PerPlatform"] = "Benutzerdefiniert",
        ["Settings_TwitchApi_ViewerCountIncludeTwitch"] = "Twitch einschließen",
        ["Settings_TwitchApi_ViewerCountIncludeKick"] = "Kick einschließen",
        ["Settings_TwitchApi_ViewerCountIncludeYouTube"] = "YouTube einschließen",
