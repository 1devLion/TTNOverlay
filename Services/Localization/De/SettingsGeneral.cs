...
internal static partial class DeStrings
{
    private static readonly Dictionary<string, string> SettingsGeneralEntries = new()
    {
        ...
        ["Settings_General_ChatSource"] = "Chat-Quelle",
        ["Settings_ChatSource_Twitch"] = "Twitch",
        ["Settings_ChatSource_Kick"] = "Kick",
        ["Settings_ChatSource_Multichat"] = "Multichat (Twitch + Kick)",
        ["Settings_General_ChannelKick"] = "Kick-Kanal",
        ["Settings_General_ChannelShared"] = "Kanal",
        ["Settings_General_MultichatEnableTwitch"] = "Twitch aktivieren",
        ["Settings_General_MultichatEnableKick"] = "Kick aktivieren",
        ["Settings_General_MultichatUseSameChannel"] = "Denselben Kanalnamen für beide verwenden",
