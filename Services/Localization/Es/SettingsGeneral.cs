...
internal static partial class EsStrings
{
    private static readonly Dictionary<string, string> SettingsGeneralEntries = new()
    {
        ...
        ["Settings_General_ChatSource"] = "Fuente de chat",
        ["Settings_ChatSource_Twitch"] = "Twitch",
        ["Settings_ChatSource_Kick"] = "Kick",
        ["Settings_ChatSource_Multichat"] = "Multichat (Twitch + Kick)",
        ["Settings_General_ChannelKick"] = "Canal de Kick",
        ["Settings_General_ChannelShared"] = "Canal",
        ["Settings_General_MultichatEnableTwitch"] = "Activar Twitch",
        ["Settings_General_MultichatEnableKick"] = "Activar Kick",
        ["Settings_General_MultichatUseSameChannel"] = "Usar el mismo nombre de canal para ambos",
