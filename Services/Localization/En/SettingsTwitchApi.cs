...
internal static partial class EnStrings
{
    private static readonly Dictionary<string, string> SettingsTwitchApiEntries = new()
    {
        ...
        ["Settings_TwitchApi_ViewerCountMode"] = "Viewer count display",
        ["Settings_ViewerCountMode_Sum"] = "Total (sum of all platforms)",
        ["Settings_ViewerCountMode_PerPlatform"] = "Custom, one per platform",
        ["Settings_TwitchApi_ViewerCountIncludeTwitch"] = "Include Twitch",
        ["Settings_TwitchApi_ViewerCountIncludeKick"] = "Include Kick",
        ["Settings_TwitchApi_ViewerCountIncludeYouTube"] = "Include YouTube",
